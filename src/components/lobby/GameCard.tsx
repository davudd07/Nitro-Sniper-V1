...
export function GameCard({ game, onSoon }: { game: LobbyGame; onSoon?: () => void }) {
  ...
  const className = clsx(
    "group relative block aspect-[3/4] w-[158px] shrink-0 overflow-hidden rounded-xl border-2 border-white/10 shadow-[4px_4px_0_#050808] transition-transform sm:w-[176px]",
