    ...
    <div className="mx-auto max-w-2xl space-y-6">
      <div className="relative overflow-hidden rounded-xl border-2 border-cyan-400/40 bg-gradient-to-br from-cyan-500/15 via-[#102020] to-[#0c1414] p-6 shadow-[4px_4px_0_#050808]">
        ...
        <p className="mt-2 max-w-lg text-sm leading-relaxed text-slate-300">
          Invite friends into this play-money showcase. You earn a Shard cut of their demo wager — never cash,
      ...
      <div className="surface p-5">
        ...
        <p className="mt-3 text-xs leading-relaxed text-slate-400">
          Simulated cut: {Math.round(DEMO_CUT * 100)}% of referred demo wager, paid in Shards. This page does not
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="surface p-5">
          ...
          <p className="mt-2 font-mono text-3xl font-black text-white">0 WL</p>
          <p className="mt-2 text-xs text-slate-400">No live referrals in this local demo.</p>
        </div>
        <div className="surface p-5">
          <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-slate-500">Shard cut</p>
