...
export function DemoBanner() {
  return (
    <div className="border-b border-white/[0.05] bg-white/[0.025] px-4 py-2 text-center text-[12px] leading-relaxed text-slate-400">
      ...
      Play-money showcase — World Locks and Shards have no cash value. Bet 0 for a demo round; any stake above 0 spends World Locks. Claim rakeback on Rewards (4% of the house-edge slice, in World Locks).
    </div>
  );
}
