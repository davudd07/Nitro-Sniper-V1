    ...
    <div className="space-y-6">
      <div className="relative overflow-hidden rounded-xl border-2 border-amber-400/50 bg-gradient-to-br from-amber-400/20 via-[#152018] to-[#0c1410] p-6 shadow-[0_0_40px_rgba(250,204,21,0.12)]">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-amber-100/70">Rakeback in Shards · chat rain every 30 minutes</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <div className="surface p-5">
          <p className="text-[11px] font-bold uppercase tracking-[0.16em] text-slate-500">Lifetime rakeback</p>
          <p className="mt-2 font-mono text-3xl font-black text-cyan-300">{formatCredits(totalRakeback ?? 0)} SH</p>
          <p className="mt-2 text-xs leading-relaxed text-slate-400">
            Every real stake (bet &gt; 0) pays {formatPercent(RAKEBACK_OF_EDGE)} of the house-edge slice back as Shards.
            A 100 SH mines bet (4% edge) returns {formatCredits(100 * 0.04 * 0.04)} SH. Demo bets (0) earn none.
          </p>
        </div>
        <div className="surface p-5">
